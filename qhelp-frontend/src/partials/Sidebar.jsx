        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          >
            <object
              ...
              className={`m-0 w-1/2  xl:w-1/2 transition-all pointer-events-none text-center ${
                sidebarExpanded ? " w-1/2 xl:w-1/2" : "w-full lg:w-full"
              }`}
            />
            {sidebarExpanded ? (
              <h3 className="text-slate-400 text-xl font-semibold ">QHelp</h3>
            ) : (
              <h3 className="text-slate-400 text-xl font-semibold  hidden">
                QHelp
              </h3>
            )}
          </NavLink>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li
                className={`rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("Tickets") && "bg-slate-900"
                }`}
              >
                <SidebarLink
                  to="/tickets"
